...
[Binary.Hacks 黑客秘笈100选](Binary-Hacks.pdf) 是一本比较老的书，里面记录了一些有意思的技巧，本篇blog是对该书的一些总结和补充。
...
## [Hack 84] [使用Jockey记录，再生Linux的程序运行](Jockey.pdf)

原理是记录了外部调用的结果，并对结果进行重放。论文还没有仔细看过，看原理有点打桩的意思。

## [Hack 85] [使用prelink加速程序启动](prelink.pdf)
